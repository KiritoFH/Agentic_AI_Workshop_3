...
def summarizer(state) -> str:
    ...
    system_prompt = """You are a keen observer at a Singapore wet market who has been listening to the conversation.
...
Format your summary in a clear, engaging way that captures the essence of wet market banter.
...
Please provide a summary of this wet market conversation."""
    ...
    try:
        ...
        # Format with header
        return f"=== WET MARKET CONVERSATION SUMMARY ===\n\n{summary}"
